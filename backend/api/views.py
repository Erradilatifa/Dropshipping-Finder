...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def analyze(self, request, pk=None):
        ...
        # Temporarily disabled - AI engine not fully configured
        # scorer = ProductScorer()
        # analysis = scorer.analyze_product_potential({
        ...
        analysis = {'message': 'AI analysis temporarily unavailable'}
    ...
    def category_trends(self, request):
        ...
        # Mock response for now
        trends = {'message': 'Trend analysis temporarily unavailable', 'category': category}
